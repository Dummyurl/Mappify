...
/**
 * Created by Karshima on 4/13/2017.
 */
        ...
        import com.example.karshima.mappifyapp.Mymap.DataParser;
            ...
            public void onMapClick(LatLng point) {
               ...
               /* if (MarkerPoints.size() > 1) {
                ...
                if(MarkerPoints.isEmpty()){
                    ...
                    MarkerPoints.add(new LatLng(mMap.getMyLocation().getLatitude(),mMap.getMyLocation().getLongitude()));

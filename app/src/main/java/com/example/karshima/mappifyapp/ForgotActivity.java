...
public class ForgotActivity extends AppCompatActivity implements  View.OnClickListener{
  ...
  private Toolbar toolbar;
    ...
    private void forgot() {
            ...
            public void onSuccess(JSONObject json) {
                ...
                try{
                    ...
                    if(status==1){
                        ...
                        MyUtility.showToast("Password Send to your Mail!!",ForgotActivity.this);
        ...
        sendRequest.execute("http://mappify.ccube9gs.com/app/User/forgot_password");
